...
class CLWrapperClass_average_precompiled_OverlapKernel_average_kernel_1d_row
{
public:
...
static unsigned char average_kernel_1d_row(skepu_region1d_unsigned__space__char m, unsigned long elemPerPx)
{
...
__kernel void average_precompiled_OverlapKernel_average_kernel_1d_row_Vector( __global unsigned char* skepu_output, __global unsigned char* m, unsigned long elemPerPx, 
...
)
{
	...
	if (skepu_i >= out_offset && skepu_i < out_offset + out_numelements)
		skepu_output[skepu_i - out_offset] = average_kernel_1d_row(skepu_region, elemPerPx);
}

__kernel void average_precompiled_OverlapKernel_average_kernel_1d_row_MatRowWise( __global unsigned char* skepu_output, __global unsigned char* m, unsigned long elemPerPx, 
...
__kernel void average_precompiled_OverlapKernel_average_kernel_1d_row_MatColWise( __global unsigned char* skepu_output, __global unsigned char* m, unsigned long elemPerPx, 
	__global unsigned char* skepu_wrap, size_t skepu_n, size_t skepu_overlap, size_t out_offset, size_t out_numelements,
	...
	)
{
	...
	if ((arrInd >= out_offset) && (arrInd < out_offset+out_numelements))
		skepu_output[arrInd-out_offset] = average_kernel_1d_row(skepu_region, elemPerPx);
}

__kernel void average_precompiled_OverlapKernel_average_kernel_1d_row_MatColWiseMulti( __global unsigned char* skepu_output, __global unsigned char* m, unsigned long elemPerPx, 
...
)
{
	...
	if (arrInd < out_numelements )
		skepu_output[arrInd] = average_kernel_1d_row(skepu_region, elemPerPx);
}
)###");
		...
		for (skepu::backend::Device_CL *device : skepu::backend::Environment<int>::getInstance()->m_devices_CL)
		{
			...
			cl_kernel kernel_vector = clCreateKernel(program, "average_precompiled_OverlapKernel_average_kernel_1d_row_Vector", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D vector kernel 'average_precompiled_OverlapKernel_average_kernel_1d_row'");

			cl_kernel kernel_matrix_row = clCreateKernel(program, "average_precompiled_OverlapKernel_average_kernel_1d_row_MatRowWise", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix row-wise kernel 'average_precompiled_OverlapKernel_average_kernel_1d_row'");

			cl_kernel kernel_matrix_col = clCreateKernel(program, "average_precompiled_OverlapKernel_average_kernel_1d_row_MatColWise", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix col-wise kernel 'average_precompiled_OverlapKernel_average_kernel_1d_row'");

			cl_kernel kernel_matrix_col_multi = clCreateKernel(program, "average_precompiled_OverlapKernel_average_kernel_1d_row_MatColWiseMulti", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix col-wise multi kernel 'average_precompiled_OverlapKernel_average_kernel_1d_row'");
