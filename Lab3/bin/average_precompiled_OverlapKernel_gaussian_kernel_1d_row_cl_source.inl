...
class CLWrapperClass_average_precompiled_OverlapKernel_gaussian_kernel_1d_row
{
public:
...
{ return v.data[i]; }
static unsigned char gaussian_kernel_1d_row(skepu_region1d_unsigned__space__char m, skepu_vec_proxy_float stencil, unsigned long elemPerPx)
{
...
__kernel void average_precompiled_OverlapKernel_gaussian_kernel_1d_row_Vector( __global unsigned char* skepu_output, __global unsigned char* m, __global float *skepu_container_stencil, size_t skepu_size_stencil, unsigned long elemPerPx, 
...
skepu_region1d_unsigned__space__char skepu_region = { .data = &sdata[tid+skepu_overlap], .oi = skepu_overlap, .stride = 1 };
	...
	if (skepu_i >= out_offset && skepu_i < out_offset + out_numelements)
		skepu_output[skepu_i - out_offset] = gaussian_kernel_1d_row(skepu_region, stencil, elemPerPx);
}

__kernel void average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatRowWise( __global unsigned char* skepu_output, __global unsigned char* m, __global float *skepu_container_stencil, size_t skepu_size_stencil, unsigned long elemPerPx, 
...
__kernel void average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatColWise( __global unsigned char* skepu_output, __global unsigned char* m, __global float *skepu_container_stencil, size_t skepu_size_stencil, unsigned long elemPerPx, 
	__global unsigned char* skepu_wrap, size_t skepu_n, size_t skepu_overlap, size_t out_offset, size_t out_numelements,
...
skepu_region1d_unsigned__space__char skepu_region = { .data = &sdata[tid+skepu_overlap], .oi = skepu_overlap, .stride = 1 };
	...
	if ((arrInd >= out_offset) && (arrInd < out_offset+out_numelements))
		skepu_output[arrInd-out_offset] = gaussian_kernel_1d_row(skepu_region, stencil, elemPerPx);
}

__kernel void average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatColWiseMulti( __global unsigned char* skepu_output, __global unsigned char* m, __global float *skepu_container_stencil, size_t skepu_size_stencil, unsigned long elemPerPx, 
...
skepu_region1d_unsigned__space__char skepu_region = { .data = &sdata[tid+skepu_overlap], .oi = skepu_overlap, .stride = 1 };
	...
	if (arrInd < out_numelements )
		skepu_output[arrInd] = gaussian_kernel_1d_row(skepu_region, stencil, elemPerPx);
}
)###");
		...
		for (skepu::backend::Device_CL *device : skepu::backend::Environment<int>::getInstance()->m_devices_CL)
		{
			...
			cl_kernel kernel_vector = clCreateKernel(program, "average_precompiled_OverlapKernel_gaussian_kernel_1d_row_Vector", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D vector kernel 'average_precompiled_OverlapKernel_gaussian_kernel_1d_row'");

			cl_kernel kernel_matrix_row = clCreateKernel(program, "average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatRowWise", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix row-wise kernel 'average_precompiled_OverlapKernel_gaussian_kernel_1d_row'");

			cl_kernel kernel_matrix_col = clCreateKernel(program, "average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatColWise", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix col-wise kernel 'average_precompiled_OverlapKernel_gaussian_kernel_1d_row'");

			cl_kernel kernel_matrix_col_multi = clCreateKernel(program, "average_precompiled_OverlapKernel_gaussian_kernel_1d_row_MatColWiseMulti", &err);
			CL_CHECK_ERROR(err, "Error creating MapOverlap 1D matrix col-wise multi kernel 'average_precompiled_OverlapKernel_gaussian_kernel_1d_row'");
